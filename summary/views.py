...
def index(request):
    ...
    # when invoking send_icx, an error occur
    
    # call = CallBuilder().from_(wallet_from)\        #when invoking a transfer method, using callBuilder or others? 
    # .to(default_score)\   
    # .method("send_icx")\
    # .build()
    ...
    #   File "/home/khchoi/icon-tutorial/venv/lib/python3.6/site-packages/iconsdk/providers/http_provider.py", line 86, in return_customed_response
